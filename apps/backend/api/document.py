...
def list_documents(
    ...
    return document_service.list_documents(db, domain=domain, published_only=False)
...
async def create_document(
    ...
    return await document_service.save_uploaded_document(db, file, domain, parsed_tags)
